...
/**
 * Created by Alien on 14/08/2017.
 */
...
import static com.makeramen.roundedimageview.Corner.*;
...
public final class RoundedTransformationBuilder {
    ...
    public RoundedTransformationBuilder cornerRadius(float radius) {
        mCornerRadii[TOP_LEFT] = radius;
        mCornerRadii[TOP_RIGHT] = radius;
        mCornerRadii[BOTTOM_RIGHT] = radius;
        mCornerRadii[BOTTOM_LEFT] = radius;
        return this;
    }
